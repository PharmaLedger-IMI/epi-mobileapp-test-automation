...
describe('073_Edit product to check expiration date is incorrect and delete smpc. Pass incorrect expiry date in matrix', () => {
    ...
    it('Mobile App - should display LeafLet to check expiration date is incorrect and delete smpc. Pass incorrect expiry date in matrix', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit product to check expiration date is incorrect and delete smpc. Pass incorrect expiry date in matrix');
