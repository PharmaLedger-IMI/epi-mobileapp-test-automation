...
describe('052_Edit batch to update valid serial number', () => {
    ...
    it('Mobile App - should open LeafLet for to update valid serial number', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit batch to update valid serial number');
        //Wait timeout for Leaflet to be displayed
        await updateBatchWithSNTest.waitTimeout();
        await timeoutWait.setTimeoutWait(4);
        //display details on Leaflet for recalled batch scenario
        await updateBatchWithSNTest.updateBatchWithSerialNumberDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
        await updateBatchWithSNTest.updateBatchWithSerialNumberLeafletDataFetch();
        await timeoutWait.setTimeoutWait(3);
