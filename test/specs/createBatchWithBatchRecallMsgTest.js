...
describe('024_Create a batch to set batch recall and recall message', () => {
    ...
    it('Mobile App - should dispaly LeafLet for Create Batch with Batch Recall Message', async () => {
        allureReporter.addFeature('Leaflet displayed for Create Batch With Batch Recall Message');
        //Wait timeout for Leaflet to be displayed
        await createBatchWithBatchRecallMsg.waitTimeout();
        await timeoutWait.setTimeoutWait(3);
        //display details on Leaflet for recalled batch scenario
        await createBatchWithBatchRecallMsg.createBatchWithBatchRecallMsgDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
        await createBatchWithBatchRecallMsg.createBatchWithBatchRecallMsgLeafletDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
