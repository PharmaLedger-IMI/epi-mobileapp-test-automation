...
describe('039_Create a batch with MonthYear as expiry date and enable day selection, disable incorrect and enable expired date flag', () => {
    ...
    it('Mobile App - should open LeafLet for with MonthYear as expiry date and enable day selection, disable incorrect and enable expired date flag', async () => {
        allureReporter.addFeature('Leaflet displayed for MonthYear as expiry date and enable day selection, disable incorrect and enable expired date flag');
        //Wait timeout for Leaflet to be displayed
        await enableDaySelectionExpiredDateDisableIncorrectFlag.waitTimeout();
        await timeoutWait.setTimeoutWait(4);
        //display details on Leaflet for recalled batch scenario
        await enableDaySelectionExpiredDateDisableIncorrectFlag.enableDaySelectionWithExpiredDateDisableIncorrectDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
        await enableDaySelectionExpiredDateDisableIncorrectFlag.enableDaySelectionWithExpiredDateDisableIncorrectLeafletDataFetch();
        await timeoutWait.setTimeoutWait(3);
