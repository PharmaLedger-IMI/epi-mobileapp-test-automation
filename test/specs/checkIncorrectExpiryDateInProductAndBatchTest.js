const checkIncorrectExpiryDateInProductAndBatchTest = require('../pageObjectsNativeApp/checkIncorrectExpiryDateInProductAndBatch')
...
describe('072_Edit product to check expiration date is incorrect and edit batch to have incorrect expiry date', () => {
        ...
        it('Mobile App - should display LeafLet details for check expiration date is incorrect and edit batch to have incorrect expiry date', async () => {
                allureReporter.addFeature('LeafLet displayed for Edit product to check expiration date is incorrect and edit batch to have incorrect expiry date');
