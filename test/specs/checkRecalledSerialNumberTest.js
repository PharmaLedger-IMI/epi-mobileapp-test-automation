...
describe('043_Create a batch and enable serial number verification and set recalled serial numbers', () => {
    ...
    it('Mobile App - should open LeafLet for enable serial number verification and set recalled serial numbers', async () => {
        allureReporter.addFeature('Leaflet displayed for Create a batch and enable serial number verification and set recalled serial numbers');
        //Wait timeout for Leaflet to be displayed
        await checkRecalledSerialNumberTest.waitTimeout();
        await timeoutWait.setTimeoutWait(4);
        //display details on Leaflet for recalled batch scenario
        await checkRecalledSerialNumberTest.checkRecalledSerialNumberDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
        await checkRecalledSerialNumberTest.checkRecalledSerialNumberLeafletDataFetch();
        await timeoutWait.setTimeoutWait(3);
