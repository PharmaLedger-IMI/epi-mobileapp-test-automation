...
describe('107_Scan previous batch to see the leaflet at product level', () => {
        ...
        it('Mobile App - should display LeafLet details for batch to see the leaflet at product level', async () => {
                allureReporter.addFeature('LeafLet displayed for Scan previous batch to see the leaflet at product level');
