...
describe('055_Edit batch to update without decommissioned and recalled serial number', () => {
    ...
    it('Mobile App - should open LeafLet to update without decommissioned and recalled serial number', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit batch to update without decommissioned and recalled serial number');
        //Wait timeout for Leaflet to be displayed
        await updateBatchWithoutDecommissionedRecalledSNTest.waitTimeout();
        await timeoutWait.setTimeoutWait(4);
        //display details on Leaflet for recalled batch scenario
        await updateBatchWithoutDecommissionedRecalledSNTest.updateBatchWithoutDecommissionedAndRecalledDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
        await updateBatchWithoutDecommissionedRecalledSNTest.updateBatchWithoutDecommissionedAndRecalledLeafletDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
