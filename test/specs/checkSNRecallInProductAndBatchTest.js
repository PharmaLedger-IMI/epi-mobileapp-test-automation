...
describe('081_Edit product to check SN is recalled and edit batch to set recall message', () => {
    ...
    it('Mobile App - should display LeafLet Details to check SN is recalled and edit batch to set recall message', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit product to check SN is recalled and edit batch to set recall message');
        //Wait timeout for Leaflet to be displayed
        await createSnRecallInProductAndBatch.waitTimeout();
        await timeoutWait.setTimeoutWait(4);
        //display details on Leaflet for recalled batch scenario
        await createSnRecallInProductAndBatch.checkSNRecallInProductAndBatchDetailsFetch();
        await timeoutWait.setTimeoutWait(3);
