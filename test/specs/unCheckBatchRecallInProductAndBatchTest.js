...
describe('069_Edit product to uncheck batch is recalled and edit batch to uncheck batch recall', () => {
    ...
    it('Mobile App - should display LeafLet for to uncheck batch is recalled and edit batch to uncheck batch recall', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit product to uncheck batch is recalled and edit batch to uncheck batch recall');
