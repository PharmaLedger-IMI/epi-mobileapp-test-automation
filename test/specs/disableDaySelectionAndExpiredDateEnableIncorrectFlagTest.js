const disableDaySelectionExpiredDateCheckIncorrectFlag = require('../pageObjectsNativeApp/disableDaySelectionAndExpiredDateEnableIncorrectFlag')
const allureReporter = require('@wdio/allure-reporter').default
const nativePatientPage = require('../pageObjectsNativeApp/patientSettingPage')
const timeoutWait = require('../utils/setTimeout')


describe('036_Create a batch with MonthYear as expiry date and disable day selection, enable incorrect and disable expired date flag', () => {
