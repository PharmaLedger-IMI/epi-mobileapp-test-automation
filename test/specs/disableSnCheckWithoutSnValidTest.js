...
describe('010_Edit batch and disable serial number check without SN', () => {
        ...
        it('Mobile App-should display LeafLet details without SN', async () => {
                ...
                await disableSnCheckWithoutSNIsValidTest.disableSNCheckWithoutSnValidDetailsFetch();
                await timeoutWait.setTimeoutWait(2);
                await disableSnCheckWithoutSNIsValidTest.disableSNCheckWithoutSnValidLeafletDataFetch();
                await timeoutWait.setTimeoutWait(2);
