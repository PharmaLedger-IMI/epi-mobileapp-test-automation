...
describe('088_Edit product to check SN is decommissioned and delete smpc. Edit batch to set decommissioned serial number', () => {
    ...
    it('Mobile App - should display LeafLet to check SN is decommissioned and delete smpc. Edit batch to set decommissioned serial number', async () => {
        allureReporter.addFeature('Leaflet displayed for Edit product to check SN is decommissioned and delete smpc. Edit batch to set decommissioned serial number');
