...
class DisableDaySelectionWithIncorrectAndExpiredDateFlag{
    ...
    async disableDaySelectionWithIncorrectAndExpiredDateFlagFetch(){
        ...
        console.log("Batch Info Details of Leaflet is: "+ leafletInfoFetch);
         ...
         const dateafter=moment(datebefore, "MMM-YYYY").format("YYMM")
...
module.exports=new DisableDaySelectionWithIncorrectAndExpiredDateFlag();