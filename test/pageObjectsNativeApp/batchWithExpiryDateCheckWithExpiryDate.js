...
class BatchWithExpiryDateCheckwithExpiryDate {
    ...
    get expiryDateBatchLearnMore() {
        return $("(//android.view.View/child::android.widget.TextView)[6]")
    }

    get expiryDatePopUpMsg() {
        return $("(//android.app.Dialog/descendant::android.view.View[5]/child::android.widget.TextView)")
    }

    get closeExpiryDatePopUpMsg() {
    ...
    async waitTimeout() {
        ...
        await timeoutWait.waitForElement(this.expiryDateTextBatch);
    ...
    async batchWithExpiryDateCheckWithExpiryDateDetailsFetch() {
        ...
        await this.expiryDateBatchLearnMore.click();
        await timeoutWait.setTimeoutTime(3);
        await this.expiryDatePopUpMsg.getText();
        await timeoutWait.setTimeoutTime(3);
        await this.closeExpiryDatePopUpMsg.click();
        await timeoutWait.setTimeoutTime(3);
    ...
    async batchWithExpiryDateCheckWithExpiryDateLeafletDetailsFetch() {
...
module.exports = new BatchWithExpiryDateCheckwithExpiryDate();