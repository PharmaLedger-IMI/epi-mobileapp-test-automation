...
class EditBatchRecallForNonSerialzedSN {
    ...
    async batchRecallNonSerializedWithoutSNDetailsFetch() {
    ...
    async batchRecallNonSerializedWithoutSNLeafletDetailsFetch() {
...
module.exports = new EditBatchRecallForNonSerialzedSN();