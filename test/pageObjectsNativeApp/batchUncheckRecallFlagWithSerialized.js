...
class EditBatchUncheckRecallForSerialzed {
    ...
    async batchUncheckRecallFlagWithSerializedDetailsFetch() {
        ...
        await timeoutWait.setTimeoutTime(3);
        // get batch info text
        const batchInfoTxt = await this.batchInfoMsg.getText();
        await timeoutWait.setTimeoutTime(3);
    ...
    async batchUncheckRecallFlagWithSerializedLeafletDataFetch() {
