...
class CreateBatchWithExpiredDate {
    ...
    async waitTimeout() {
        ...
        await timeoutWait.waitForElement(this.expiredDateText);
    ...
    async createBatchWithExpiredDateFetch() {
        ...
        await timeoutWait.setTimeoutTime(3);
        await this.expiredDatePopUpMsg.getText();
        await timeoutWait.setTimeoutTime(3);
...
module.exports = new CreateBatchWithExpiredDate();