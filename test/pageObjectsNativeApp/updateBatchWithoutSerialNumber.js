...
class UpdateBatchWithoutSN {
    ...
    async updateBatchWithoutSerialNumberDetailsFetch() {
    ...
    async updateBatchWithoutSerialNumberLeafletDetailsFetch() {
...
module.exports = new UpdateBatchWithoutSN();