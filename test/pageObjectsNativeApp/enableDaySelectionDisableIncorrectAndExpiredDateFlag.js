...
class EnableDaySelectionDisableIncorrectExpiredDateFlag {
    ...
    async enableDaySelectionDisableIncorrectExpiredDateLeafletDataFetch() {
...
module.exports = new EnableDaySelectionDisableIncorrectExpiredDateFlag();