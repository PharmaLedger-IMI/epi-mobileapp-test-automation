...
class UpdateBatchDecommissionedAndRecalledSN {
    ...
    async waitTimeout() {
        ...
        await timeoutWait.waitForElement(this.decommissionedSNBatch);

    }


    async updateBatchWithDecommissionedAndRecalledSNDetailsFetch() {

        // recalled text message 
        const decommisionedSNInfoTxtBatch = await this.decommissionedSNBatch.getText();
        ...
        console.log(decommisionedSNInfoTxtBatch);
        expect(decommisionedSNInfoTxtBatch).to.equal(configData.serialNumberDecommissionedLabelMessage);

    }

    async updateBatchWithDecommissionedAndRecalledSNLeafletDetailsFetch() {
...
module.exports = new UpdateBatchDecommissionedAndRecalledSN();