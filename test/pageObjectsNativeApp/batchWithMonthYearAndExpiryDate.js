...
class BatchWithMonthYearOnDate {
    ...
    async batchWithMonthYearAndExpiryDateDetailsFetch() {
    ...
    async batchWithMonthYearAndExpiryDateLeafletDataFetch() {
...
module.exports = new BatchWithMonthYearOnDate();