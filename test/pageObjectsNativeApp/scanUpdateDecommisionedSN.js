...
class scanUpdateDecommissionedSN {
    ...
    get decommissionedInfoLearnMore() {
        return $("(//android.view.View[@resource-id='page-ion-content']/descendant::android.widget.TextView)[3]")
    }

    get decommissionedInfoPopUpMsg() {
        return $("(//android.app.Dialog/descendant::android.view.View[5]/child::android.widget.TextView)")
    }

    get closeDecommissionedInfoPopUpMsg() {
    ...
    async scanUpdateDecommissionedSNDetailsFetch() {

        // recalled text message 
        const decommisionedInfoTxtBatch = await this.decommissionedInfoBatch.getText();
        await timeoutWait.setTimeoutTime(2);
        await this.decommissionedInfoLearnMore.click();
        await timeoutWait.setTimeoutTime(3);
        await this.decommissionedInfoPopUpMsg.getText();
        await timeoutWait.setTimeoutTime(3);
        await this.closeDecommissionedInfoPopUpMsg.click();
        await timeoutWait.setTimeoutTime(3);
    ...
    async scanUpdateDecommissionedSNLeafletDetailsFetch() {
...
module.exports = new scanUpdateDecommissionedSN();