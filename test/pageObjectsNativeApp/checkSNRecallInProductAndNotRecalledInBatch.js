...
class CheckSNRecallInProductAndNotRecalledInBatch {
    ...
    async checkSNRecallInProductAndNotRecalledInBatchFetch() {
...
module.exports = new CheckSNRecallInProductAndNotRecalledInBatch();