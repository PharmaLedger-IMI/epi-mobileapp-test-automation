...
class EditBatchRecallForSerialzedSN {
    ...
    async batchRecallWithSerailizedDetailsFetch() {
    ...
    async batchRecallWithSerailizedLeafletDetailsFetch() {
...
module.exports = new EditBatchRecallForSerialzedSN();