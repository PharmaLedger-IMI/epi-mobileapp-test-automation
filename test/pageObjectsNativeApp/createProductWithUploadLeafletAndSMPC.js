...
class CreateProductWithLeafletandSMPC {
    ...
    async waitTimeout() {
        await timeoutWait.setTimeoutWait(38);
        //  await timeoutWait.waitForElement(this.smpcDocType);

    }


    async createProductWithLeafletandSMPCDetailsFetch() {
    ...
    async createProductWithLeafletandSMPCLeafletDetailsFetch() {
...
module.exports = new CreateProductWithLeafletandSMPC();