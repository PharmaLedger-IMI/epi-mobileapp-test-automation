...
class CheckBatchIsUnkownInProductWithvalidMatrix {
    ...
    async checkBatchIsUnknownInProductWithValidMatrixDetailsFetch() {
    ...
    async checkBatchIsUnknownInProductWithValidMatrixLeafletDetailsFetch() {
...
module.exports = new CheckBatchIsUnkownInProductWithvalidMatrix();