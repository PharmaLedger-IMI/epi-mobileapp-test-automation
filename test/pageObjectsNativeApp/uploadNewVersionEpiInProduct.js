...
class UploadNewVersionEpiUpInProduct {
    ...
    async uploadNewVersionEPIInProductDetailsFetch() {
    ...
    async uploadNewVersionEPIInProductLeafletDataFetch() {
...
module.exports = new UploadNewVersionEpiUpInProduct();