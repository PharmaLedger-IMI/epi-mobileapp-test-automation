...
class DisableDaySelectionCheckExpiredDateFlag {
    ...
    async waitTimeout() {
        ...
        await timeoutWait.waitForElement(this.productExpiredTextBatch);

    }

    async disableDaySelectionAndIncorrectCheckExpiredDateFlagDetailsFetch() {
...
module.exports = new DisableDaySelectionCheckExpiredDateFlag();