...
class CreateBatchWithBatchMsgRecallMsg {
    ...
    get batchTxtMsg() {
        return $("(//android.app.Dialog/descendant::android.view.View/child::android.widget.TextView)[3]")
    }
    ...
    async createBatchWithBatchRecallMsgDetailsFetch() {
    ...
    async createBatchWithBatchRecallMsgLeafletDetailsFetch() {
...
module.exports = new CreateBatchWithBatchMsgRecallMsg();