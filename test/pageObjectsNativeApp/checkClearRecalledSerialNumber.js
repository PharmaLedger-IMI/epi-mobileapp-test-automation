...
class CheckClearRecalledSerialNumber {


    //failedSN Batch 
    get failedSNInfoBatch() {
    ...
    async waitTimeout() {
        ...
        await timeoutWait.waitForElement(this.failedSNInfoBatch);
    ...
    async checkClearRecalledSerialNumberLeafletDetailsFetch() {
...
module.exports = new CheckClearRecalledSerialNumber();