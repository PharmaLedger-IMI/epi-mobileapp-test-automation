...
class UncheckSNDecommissionedInProductAndDecommissonedInBatch {
    ...
    async uncheckSNDecommissionedInProductAndDecommissonedInBatchFetch() {
        ...
        const decommissionedBatchTxt = await this.decommissionedTextBatch.getText();
        ...
        expect(decommissionedBatchTxt).to.equal(configData.serialNumberDecommissionedLabelMessage)
