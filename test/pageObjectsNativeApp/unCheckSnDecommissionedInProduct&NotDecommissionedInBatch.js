...
class UncheckSNDecommissionedInProductAndNotDecommissonedInBatch {
    ...
    async uncheckSNDecommissionedInProductAndNotDecommissonedInBatchFetch() {

        // recalled text message 
        await this.faliedSNTextBatch.getText();
        ...
        await timeoutWait.setTimeoutTime(3);
        await this.closeFaliedSNPopUpMsg.click();
        await timeoutWait.setTimeoutTime(3);
...
module.exports = new UncheckSNDecommissionedInProductAndNotDecommissonedInBatch();