...
class CreateBatchWithUploadLeaflet {
    ...
    async createBatchWithLeafletUploadDetailsFetch() {
    ...
    async createBatchWithLeafletUploadLeafletDataFetch() {
...
module.exports = new CreateBatchWithUploadLeaflet();