...
class BatchClearValidSNUpdateRecalledSN{
    ...
    async batchClearValidSNUpdateRecalledSNFetch(){
     
        // recalled text message 
        await this.recalledInfoBatch.getText();
...
module.exports=new BatchClearValidSNUpdateRecalledSN();