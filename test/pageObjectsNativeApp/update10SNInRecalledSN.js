...
class Update10SNInRecalledSN {
    ...
    async update10SNInRecalledSNDetailsFetch() {
    ...
    async update10SNInRecalledSNLeafletDetailsFetch() {
...
module.exports = new Update10SNInRecalledSN();