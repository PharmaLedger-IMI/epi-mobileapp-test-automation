...
class CheckSmpcDeletedFromProductWithSnIsUnknown {
    ...
    async checkSmpcDeletedFromProductWithSnIsUnknownFetch() {
...
module.exports = new CheckSmpcDeletedFromProductWithSnIsUnknown();