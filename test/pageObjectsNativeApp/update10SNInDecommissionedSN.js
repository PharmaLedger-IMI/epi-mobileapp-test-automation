...
class Update10SNInDecommissionedSN{
    ...
    //recalled Batch 
    get decommssionedInfoBatch(){
        return $("(//android.view.View[@resource-id='page-ion-content']/descendant::android.widget.TextView)[2]")
    }

    get decommssionedInfoLearnMore(){
        return $("(//android.view.View[@resource-id='page-ion-content']/descendant::android.widget.TextView)[3]")
    }

    get decommssionedInfoPopUpMsg(){
        return $("(//android.app.Dialog/descendant::android.view.View[5]/child::android.widget.TextView)")
    }

    get closeDecommssionedInfoPopUpMsg(){
    ...
    async update10SNInDecommissionedSNFetch(){
     
        // recalled text message 
        await this.decommssionedInfoBatch.getText();
        await timeoutWait.setTimeoutTime(3);
        // product info message
        await this.decommssionedInfoLearnMore.click();
        await timeoutWait.setTimeoutTime(3);
        await this.decommssionedInfoPopUpMsg.getText();
        await timeoutWait.setTimeoutTime(3);
        await this.closeDecommssionedInfoPopUpMsg.click();
        await timeoutWait.setTimeoutTime(3);
